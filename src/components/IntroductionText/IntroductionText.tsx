    ...
    <ThemeProvider theme={theme}>
      <Container id='main'>
        ...
        <Typography id='description' variant='body1'>
          I'm a junior developer from Brazil. Currently open for opportunities. Im my spare time i enjoy building new projects, gaming. My preferred tools are C#, nodejs and React.
        </Typography>
        <Typography id='links' variant='body2'>
