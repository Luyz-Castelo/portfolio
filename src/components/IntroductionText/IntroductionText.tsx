  ...
  return (
    <StyledContainer>
      ...
      <StyledTypography variant='body2'>
        I'm on <StyledLink href='https://github.com/Luyz-Castelo'>Github</StyledLink> and <StyledLink href='https://www.linkedin.com/in/luyz-castelo-branco-1412a3205/'>Linkedin</StyledLink>.
      </StyledTypography>
    </StyledContainer>
  )
}
